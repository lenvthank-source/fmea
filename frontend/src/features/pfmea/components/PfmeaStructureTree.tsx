            ...
            <>
              <Stack direction="row" spacing={0.75} sx={{ alignItems: 'center' }}>
                ...
                <Chip
                  ...
                  size="small"
                  sx={{ bgcolor: 'rgba(15, 23, 42, 0.06)', color: 'text.primary', fontWeight: 'bold', height: 30, fontSize: '0.75rem' }}
                />
                <Chip
                  label={`${linkageStats.linked} Linked`}
                  size="small"
                  color="success"
                  sx={{ fontWeight: 'bold', height: 30, fontSize: '0.75rem' }}
                />
                            ...
                            return (
                              <Box key={failIdx} sx={{ mb: 0.5 }}>
                                <Stack 
                                  ...
                                  sx={getNodeRowStyle(failNodeId)}
                                >
                                  <TreeIconBadge type={isLinked ? 'linked' : 'failure'} iconSrc={TREE_ASSETS.failure} />
